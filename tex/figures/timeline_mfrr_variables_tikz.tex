...
\begin{tikzpicture}[scale=0.75,every text node part/.style={align=center}]
  ...
  \node at (2,0) {\LARGE $*$ $p_{h}^{r,\uparrow}$};
  ...
  \node at (12,0) {\LARGE $*$ $\lambda_{h,\omega}^{\text{bid}}$};
  ...
  \node at (17,0) {\LARGE $\Gamma_{\omega}$};
  % {\LARGE $\Bigl( \bm{p}^{r,\uparrow}, \bm{\lambda}_{\omega}^{\text{bid}}, \bm{p}_{\omega}^{b,\uparrow}, \bm{p}_{\omega}^{b,\downarrow}, \bm{s}_{\omega}, \bm{T}_{\omega}^{c}, \bm{T}_{\omega}^{f}, \notag \\ \quad & \quad \bm{T}_{\omega}^{c, B}, \bm{T}_{\omega}^{f,B}, \bm{\phi}_{\omega}, \bm{g}_{\omega} \Bigr)$};
  \node at (17,-2) {\LARGE D};
